...
func testSweepGameServicesGameServerDeployment(region string) error {
	...
	listTemplate := strings.Split("https://gameservices.googleapis.com/v1/projects/{{project}}/locations/{{location}}/gameServerDeployments", "?")[0]
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://gameservices.googleapis.com/v1/projects/{{project}}/locations/{{location}}/gameServerDeployments/{{deployment_id}}"
