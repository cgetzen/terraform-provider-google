...
func init() {
	resource.AddTestSweepers("GameServicesRealm", &resource.Sweeper{
		Name: "GameServicesRealm",
		F:    testSweepGameServicesRealm,
	})
}
...
func testSweepGameServicesRealm(region string) error {
	...
	listTemplate := strings.Split("https://gameservices.googleapis.com/v1/projects/{{project}}/locations/{{location}}/realms", "?")[0]
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://gameservices.googleapis.com/v1/projects/{{project}}/locations/{{location}}/realms/{{realm_id}}"
