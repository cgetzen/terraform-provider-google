...
func init() {
	resource.AddTestSweepers("DataprocMetastoreService", &resource.Sweeper{
		Name: "DataprocMetastoreService",
		F:    testSweepDataprocMetastoreService,
	})
}
...
func testSweepDataprocMetastoreService(region string) error {
	...
	listTemplate := strings.Split("https://metastore.googleapis.com/v1/projects/{{project}}/locations/{{location}}/services", "?")[0]
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://metastore.googleapis.com/v1/projects/{{project}}/locations/{{location}}/services/{{service_id}}"
